...
const tiers = [
  {
    name: "Launch",
    tagline: "Professional online presence for your car detailing business.",
    setupPrice: "$249",
    monthlyPrice: "$99",
    popular: false,
    included: [
      "Custom car detailing website design",
      "Service-focused landing pages (detailing, ceramic coating, paint correction)",
      "Booking request & contact forms",
      "Lead management CRM system",
      "Email notifications for new service inquiries",
  ...
  {
    name: "Growth",
    tagline: "Convert more car detailing leads into loyal customers automatically.",
    setupPrice: "$549",
    monthlyPrice: "$149",
    popular: true,
    included: [
      ...
      "Live chat widget for instant quotes",
      "Maintenance reminder automation",
    ],
    notIncluded: [
      "Custom service package builder",
      "Seasonal detailing campaign automation",
    ],
    cta: "Choose Growth",
  },
  {
    name: "Accelerator",
    tagline: "Scale your car detailing business with advanced automation.",
    setupPrice: "$999",
    monthlyPrice: "$299",
    popular: false,
    included: [
      "Everything in Growth",
      "Automated detailing package builder",
      "Smart follow-up sequences by service type",
      "Seasonal campaign automation",
      "Regular maintenance reminder workflows",
...
const features = [
  {
    icon: MessageSquare,
    title: "Never Miss a Detailing Lead",
    description: "Instant automated responses to every car detailing inquiry, even when you're working on a vehicle.",
  },
  {
    icon: Star,
    title: "Build Your Detailing Reputation",
    description: "Automated Google review requests sent after every detailing service to grow your 5-star ratings.",
  },
  {
    icon: Users,
    title: "Manage All Your Clients",
    description: "Track all detailing clients, vehicle history, service records, and maintenance schedules in one CRM.",
  },
  {
    icon: Zap,
    title: "Automated Lead Nurturing",
    description: "SMS and email sequences that convert detailing estimates into booked appointments.",
  },
  {
    icon: Clock,
    title: "Reclaim 10+ Hours Weekly",
    description: "Stop manually following up on quotes. Let automation handle the admin work.",
  },
  {
    icon: BarChart3,
    title: "Track Your Growth",
    description: "See which services (detailing, ceramic coating, paint protection) bring the most revenue.",
  },
]
...
const comparisonData = {
  without: [
    "Missed calls during detailing jobs",
    "Quotes forgotten by car owners",
  ...
  with: [
    ...
    "Reviews requested after every service",
    "All conversations in one place",
    "Full visibility into your pipeline",
    "System works while you detail",
  ],
}

const faqData = [
  {
    q: "How quickly can my car detailing website go live?",
    a: "Most car detailing and auto detailing websites launch within 3-7 business days. We handle the entire build — you provide your services, service areas, and branding.",
  },
  {
    q: "Do I need technical skills to manage this system?",
    a: "Not at all. Everything is built for you and managed from your phone. We provide training and ongoing support for your detailing business.",
  },
  {
    q: "Can I upgrade my plan as my detailing business grows?",
    a: "Absolutely. Upgrade or downgrade anytime with no penalties. Perfect for seasonal detailing businesses.",
  },
  {
    q: "What if I already have a car detailing website?",
    a: "We can integrate our CRM and automation with your existing site, or build a new modern detailing website. We'll recommend the best option during your consultation.",
  },
]
...
// Interactive CRM Mockup Component with 3D Mouse Tracking - Car Detailing Version
function InteractiveCRMMockup() {
  ...
  useEffect(() => {
    ...
    const leadsInterval = setInterval(() => {
      currentLeads += 1
      setNewLeads(Math.min(currentLeads, 19))
      if (currentLeads >= 19) clearInterval(leadsInterval)
    }, 100)
    ...
    const revInterval = setInterval(() => {
      currentRev += 420
      setRevenue(Math.min(currentRev, 8820))
      if (currentRev >= 8820) clearInterval(revInterval)
    }, 80)
    ...
    >
      ...
      >
        ...
        <motion.div
          ...
          style={{
            background: `radial-gradient(600px circle at ${glowX}% ${glowY}%, rgba(6,182,212,0.15), rgba(8,145,178,0.1), transparent 40%)`,
            ...
            >
              ...
              {activeTab === 'leads' && (
                <div className="space-y-3">
                  <div className="flex items-center justify-between mb-4">
                    <div>
                      <p className="text-[10px] text-white/50">Detailing CRM</p>
                  ...
                  <div className="grid grid-cols-3 gap-2 mb-4">
                    <motion.div 
                      ...
                      animate={{ scale: newLeads === 19 ? [1, 1.02, 1] : 1 }}
                      transition={{ duration: 0.3 }}
                    >
                    ...
                    <div className="rounded-xl bg-white/5 p-2.5 border border-white/10">
                      ...
                      <p className="text-lg font-bold text-teal-400">{conversions}</p>
                    </div>
                    <div className="rounded-xl bg-white/5 p-2.5 border border-white/10">
                  ...
                  {/* Lead cards */}
                  {[
                    { name: 'Alex M.', service: 'Full Detail', status: 'hot', time: 'Just now' },
                    { name: 'Emma R.', service: 'Ceramic Coating', status: 'warm', time: '7 min ago' },
                    { name: 'Ryan T.', service: 'Paint Correction', status: 'new', time: '18 min ago' },
                  ].map((lead, idx) => (
                    <motion.div
                      key={idx}
              ...
              {activeTab === 'inbox' && (
                <div className="space-y-3">
                  ...
                  {/* Message cards */}
                  {[
                    { name: 'Alex M.', msg: 'Need full detail for my Tesla...', channel: 'SMS', unread: true, time: '4m' },
                    { name: 'Emma R.', msg: 'Quote for ceramic coating?', channel: 'Email', unread: true, time: '11m' },
                    { name: 'Ryan T.', msg: 'Paint correction estimate needed', channel: 'Web', unread: true, time: '35m' },
                    { name: 'Jordan K.', msg: 'Amazing detail job, thanks!', channel: 'SMS', unread: false, time: '2h' },
                  ].map((msg, idx) => (
                    <motion.div
                      key={idx}
                      className={`rounded-xl p-3 border cursor-pointer transition-all ${
                    ...
                    >
                      <div className="flex items-start gap-3">
                        <div className="w-8 h-8 rounded-full bg-gradient-to-br from-cyan-500/30 to-teal-500/30 flex items-center justify-center text-[10px] font-bold text-white">
              ...
              {activeTab === 'reviews' && (
                <div className="space-y-3">
                  ...
                  {/* Review cards */}
                  {[
                    { name: 'Chris P.', rating: 5, text: 'Best detail ever! My car looks brand new.', time: '2 days ago' },
                    { name: 'Nicole W.', rating: 5, text: 'Professional ceramic coating service!', time: '1 week ago' },
                    { name: 'Marcus H.', rating: 5, text: 'Paint correction results are amazing!', time: '2 weeks ago' },
                  ].map((review, idx) => (
                    <motion.div
                      key={idx}
      ...
      >
        ...
        <p className="text-[9px] text-white/80 max-w-[120px]">&ldquo;Best car detail ever!&rdquo;</p>
        <p className="text-[8px] text-white/50 mt-1">— ShineAuto Detail</p>
      </motion.div>
...
function AnimatedCounter({ value, label }: { value: string; label: string }) {
  return (
    ...
    >
      <div className="text-3xl sm:text-4xl font-bold bg-gradient-to-r from-cyan-500 via-teal-500 to-blue-500 bg-clip-text text-transparent">
        {value}
      </div>
  ...
  return (
    <>
      ...
      <section className="relative pt-32 pb-20 overflow-hidden">
        ...
        <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_bottom_right,rgba(8,145,178,0.08),transparent_50%)] pointer-events-none" />
          ...
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-8 items-center justify-items-center lg:justify-items-start">
            ...
            >
              ...
              >
                ...
                <span className="text-sm font-medium text-foreground-secondary">For Car Detailing & Auto Detailing Businesses</span>
              </motion.div>
              ...
              <p className="text-lg sm:text-xl text-foreground-secondary mb-8 leading-relaxed">
                Complete car detailing business growth system: capture auto detailing leads, automate service follow-ups, collect 5-star reviews, and manage all your clients — so you can focus on making cars shine, not chasing appointments.
              </p>
      ...
      <section className="py-20 relative">
        <Container>
          <SectionHeading
            ...
            title="Running a Car Detailing Business Without vs. With Automation"
          ...
          <div className="grid md:grid-cols-2 gap-6 mt-12 max-w-4xl mx-auto">
            ...
            >
              ...
              <div className="relative rounded-2xl border border-cyan-500/30 bg-gradient-to-br from-cyan-500/5 to-teal-500/5 p-6">
                <div className="flex items-center gap-2 mb-4">
      ...
      <section className="py-20 relative">
        ...
        <Container>
          <SectionHeading
            overline="DETAILING FEATURES"
            title="Everything Your Car Detailing Business Needs"
            highlightWord="Needs"
            subtitle="Stop juggling spreadsheets and missed calls. One system for detailing bookings, ceramic coating inquiries, paint correction leads, and client management."
          />
      ...
      <section id="pricing" className="py-20 relative">
        <Container>
          <SectionHeading
            overline="DETAILING PRICING"
            title="Transparent Pricing for Auto Detailers"
            highlightWord="Pricing"
            subtitle="No hidden fees. No surprises. Perfect for car detailing, mobile detailing, and auto detailing companies."
          />
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mt-12 items-stretch">
            {tiers.map((tier, index) => (
              ...
              >
                ...
                <div className={`relative h-full rounded-2xl border ${tier.popular ? 'border-cyan-500/50' : 'border-white/10'} bg-[linear-gradient(160deg,#181116_0%,#0f0b0e_100%)] overflow-hidden transition-all duration-300 hover:border-white/20`}>
                  {/* Popular badge */}
                  {tier.popular && (
                  ...
                  <div className="p-6 sm:p-8 flex flex-col h-full">
                    ...
                    <div className="mb-6">
                      {tier.popular && (
                        <span className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full text-xs font-semibold text-white bg-gradient-to-r from-cyan-500 via-teal-500 to-blue-500 mb-3">
                    ...
                    <Link
                      ...
                      className={`w-full inline-flex items-center justify-center gap-2 h-11 px-5 font-semibold rounded-xl transition-all duration-200 mt-auto active:scale-[0.98] ${
                        tier.popular 
                          ? 'bg-gradient-to-r from-cyan-600 to-teal-600 text-white hover:brightness-110 shadow-[0_1px_2px_rgba(0,0,0,0.3),inset_0_1px_0_rgba(255,255,255,0.1)] hover:shadow-[0_4px_12px_rgba(6,182,212,0.4),inset_0_1px_0_rgba(255,255,255,0.1)]'
      ...
      <section className="py-20 relative">
        ...
        <Container>
          <SectionHeading
            ...
            title="Launch Your Detailing System in Days"
            highlightWord="Days"
          />
            ...
            {[
              {
                ...
                text: "15-minute consultation to discuss your detailing services, packages, service areas, and branding.",
                icon: Calendar,
              },
              {
                num: "02",
                title: "We Build Your System",
                text: "Custom website, CRM, and automation workflows built specifically for your car detailing business. Ready in 3-7 days.",
                icon: Zap,
              },
              {
                num: "03",
                title: "Start Capturing Detailing Leads",
                text: "Go live and start converting quotes into booked services. We monitor performance and provide ongoing support.",
                icon: BarChart3,
              },
            ].map((step, index) => (
              <motion.div
              ...
              >
                ...
                <div className="relative rounded-2xl border border-white/10 bg-[radial-gradient(circle_at_20%_20%,rgba(6,182,212,0.08),transparent_38%),radial-gradient(circle_at_80%_0%,rgba(8,145,178,0.08),transparent_40%),linear-gradient(160deg,#181116_0%,#0f0b0e_100%)] p-6 h-full transition-all duration-300 hover:border-white/20 text-center">
                  {/* Step number badge */}
                  <span className="inline-flex items-center justify-center text-3xl font-bold bg-gradient-to-br from-cyan-500/40 to-teal-500/40 bg-clip-text text-transparent mb-4 group-hover:from-cyan-500 group-hover:to-teal-500 transition-all duration-300">
                    {step.num}
                  </span>
                  
                  <div className="w-14 h-14 rounded-xl bg-gradient-to-br from-cyan-500/20 to-teal-500/20 flex items-center justify-center mx-auto mb-4 group-hover:scale-110 transition-transform duration-300 border border-cyan-500/20">
      ...
      <section className="py-20 relative">
        <Container>
          <SectionHeading
            overline="DETAILING FAQ"
            title="Common Questions from Auto Detailers"
      ...
      {/* CTA Section */}
      <section className="py-20 relative">
        <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_center,rgba(6,182,212,0.08),transparent_50%)] pointer-events-none" />
        ...
        <Container>
          ...
          >
            ...
            <div className="relative rounded-3xl border border-white/10 bg-[radial-gradient(circle_at_20%_20%,rgba(6,182,212,0.12),transparent_38%),radial-gradient(circle_at_80%_80%,rgba(8,145,178,0.12),transparent_40%),linear-gradient(160deg,#181116_0%,#0f0b0e_100%)] p-8 sm:p-12 text-center">
              ...
              <p className="text-foreground-secondary max-w-2xl mx-auto mb-8 leading-relaxed">
                Book a free 15-minute consultation. We&apos;ll discuss your car detailing services and show you how to automate your business growth.
              </p>
              <Link
                href="/schedule-a-call"
                className="inline-flex items-center justify-center gap-2 h-12 px-7 bg-gradient-to-r from-cyan-600 to-teal-600 text-white font-semibold rounded-xl transition-all duration-200 hover:brightness-110 shadow-[0_1px_2px_rgba(0,0,0,0.3),inset_0_1px_0_rgba(255,255,255,0.1)] hover:shadow-[0_4px_12px_rgba(6,182,212,0.4),inset_0_1px_0_rgba(255,255,255,0.1)] active:scale-[0.98]"
              >
                <span className="hidden sm:inline">Schedule Your Free Detailing Consultation</span>
                <span className="inline sm:hidden">Schedule Call</span>
                <ArrowRight className="w-5 h-5" />
              </Link>
              <p className="text-xs text-foreground-secondary mt-4">
                No commitment required • Perfect for car detailing and mobile detailing businesses
              </p>
            </div>
          </motion.div>
        </Container>
        ...
        <Container>
          <div className="text-center">
            <p className="text-sm text-foreground-secondary">
              Need a custom solution for your detailing business?{" "}
              <Link href="/contact-us" className="text-cyan-500 hover:text-cyan-400 transition-colors underline">
                Contact us
              </Link>{" "}
              and we&apos;ll create a tailored package for your auto detailing services.
            </p>
          </div>
        </Container>
      </section>
