...
const getTiers = () => getBasePricingTiers({
  industryName: "construction business",
})
  {
    name: "Launch",
    tagline: "Professional online presence for your construction business.",
    setupPrice: "$249",
    monthlyPrice: "$99",
    popular: false,
    included: [
      "Custom construction website design",
      "Service-focused landing pages (remodeling, framing, builds)",
  ...
  {
    name: "Growth",
    tagline: "Convert more construction leads into signed contracts automatically.",
    setupPrice: "$549",
    monthlyPrice: "$149",
    popular: true,
    included: [
  ...
  {
    name: "Accelerator",
    tagline: "Scale your construction business with advanced automation.",
    setupPrice: "$999",
    monthlyPrice: "$299",
    popular: false,
    included: [
      "Everything in Growth",
      "Automated construction estimate calculator",
      "Smart follow-up sequences by project type",
      "Dormant client win-back campaigns",
      "Project type upsell automation",
      "Priority 24/7 support",
      "Monthly performance & ROI reports",
      "Online project booking portal",
...
const features = [
  {
    icon: MessageSquare,
    title: "Never Miss a Construction Lead",
    description: "Instant automated responses to every remodeling and building inquiry, even when you're on the job site.",
  },
  {
    icon: Star,
    title: "Build Your Reputation Fast",
    description: "Automated Google review requests sent after every completed project to grow your 5-star ratings.",
  },
  {
    icon: Users,
    title: "Manage All Your Projects",
    description: "Track all construction clients, project history, and timelines in one organized CRM.",
  },
  {
    icon: Zap,
    title: "Automated Lead Nurturing",
    description: "SMS and email sequences that convert construction estimates into signed contracts.",
  },
  {
    icon: Clock,
    title: "Reclaim 10+ Hours Weekly",
    description: "Stop manually following up on project bids. Let automation handle the admin work.",
  },
  {
    icon: BarChart3,
    title: "Track Your Growth",
    description: "See which services (remodeling, new builds, renovations) bring the most revenue.",
  },
]
...
const comparisonData = {
  without: [
    "Missed calls during construction jobs",
...
const faqData = [
  {
    q: "How quickly can my construction website go live?",
    a: "Most construction and remodeling websites launch within 3-7 business days. We handle the entire build — you provide your services, service areas, and branding.",
  },
  {
    q: "Do I need technical skills to manage this system?",
    a: "Not at all. Everything is built for you and managed from your phone. We provide training and ongoing support for your construction business.",
  },
  {
    q: "Can I upgrade my plan as my construction business grows?",
    a: "Absolutely. Upgrade or downgrade anytime with no penalties. Perfect for seasonal construction businesses.",
  },
  {
    q: "What if I already have a construction website?",
    a: "We can integrate our CRM and automation with your existing site, or build a new modern construction website. We'll recommend the best option during your consultation.",
  },
]
...
// Interactive CRM Mockup Component with 3D Mouse Tracking - Construction Version
    ...
    >
      ...
      >
        ...
        <motion.div
          ...
          style={{
            background: `radial-gradient(600px circle at ${glowX}% ${glowY}%, rgba(249,115,22,0.15), rgba(234,88,12,0.1), transparent 40%)`,
            opacity: isHovered ? 1 : 0,
          }}
        />

        {/* Browser frame */}
        <div className="relative rounded-2xl overflow-hidden bg-gradient-to-b from-zinc-800 to-zinc-900 p-1 shadow-[0_25px_50px_-12px_rgba(0,0,0,0.5),0_0_60px_rgba(249,115,22,0.15)] transition-shadow duration-300 hover:shadow-[0_35px_60px_-15px_rgba(0,0,0,0.6),0_0_80px_rgba(249,115,22,0.2)]">
          {/* Browser header */}
            ...
            >
              ...
              {activeTab === 'leads' && (
                <div className="space-y-3">
                  <div className="flex items-center justify-between mb-4">
                    <div>
                      <p className="text-[10px] text-white/50">Construction CRM</p>
                      <p className="text-sm font-semibold text-white">Project Pipeline</p>
                    </div>
                    <motion.button
                  ...
                  {/* Lead cards */}
                  {[
                    { name: 'James H.', service: 'Kitchen Remodel', status: 'hot', time: 'Just now' },
                    { name: 'Amanda K.', service: 'Home Addition', status: 'warm', time: '8 min ago' },
                    { name: 'Robert S.', service: 'Foundation Repair', status: 'new', time: '15 min ago' },
                  ].map((lead, idx) => (
                    <motion.div
                      key={idx}
              ...
              {activeTab === 'inbox' && (
                <div className="space-y-3">
                  ...
                  {/* Message cards */}
                  {[
                    { name: 'James H.', msg: 'Need kitchen remodel quote...', channel: 'SMS', unread: true, time: '3m' },
                    { name: 'Amanda K.', msg: 'When can you start the addition?', channel: 'Email', unread: true, time: '10m' },
                    { name: 'Robert S.', msg: 'Foundation repair estimate?', channel: 'Web', unread: true, time: '45m' },
                    { name: 'Lisa M.', msg: 'Deck looks amazing, thank you!', channel: 'SMS', unread: false, time: '2h' },
                  ].map((msg, idx) => (
                    <motion.div
                      key={idx}
                      className={`rounded-xl p-3 border cursor-pointer transition-all ${
                    ...
                    >
                      <div className="flex items-start gap-3">
                        <div className="w-8 h-8 rounded-full bg-gradient-to-br from-orange-500/30 to-amber-500/30 flex items-center justify-center text-[10px] font-bold text-white">
                        ...
                        <div className="flex-1 min-w-0">
                          <div className="flex items-center gap-2">
                            ...
                            <span className={`text-[8px] px-1.5 py-0.5 rounded ${
                              msg.channel === 'SMS' ? 'bg-orange-500/20 text-orange-400' :
              ...
              {activeTab === 'reviews' && (
                <div className="space-y-3">
                  ...
                  {/* Review cards */}
                  {[
                    { name: 'Tom B.', rating: 5, text: 'Best contractor! Kitchen remodel is perfect.', time: '3 days ago' },
                    { name: 'Rachel P.', rating: 5, text: 'Professional work on our home addition.', time: '1 week ago' },
      ...
      >
        ...
        <p className="text-[9px] text-white/80 max-w-[120px]">&ldquo;Best contractor ever!&rdquo;</p>
...
function AnimatedCounter({ value, label }: { value: string; label: string }) {
  return (
    ...
    >
      <div className="text-3xl sm:text-4xl font-bold bg-gradient-to-r from-orange-500 via-amber-500 to-orange-600 bg-clip-text text-transparent">
        {value}
      </div>
  ...
  return (
    <>
      ...
      <section className="relative pt-32 pb-20 overflow-hidden">
        ...
        <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_bottom_right,rgba(234,88,12,0.08),transparent_50%)] pointer-events-none" />
          ...
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-8 items-center justify-items-center lg:justify-items-start">
            ...
            >
              ...
              >
                ...
                <span className="text-sm font-medium text-foreground-secondary">For Construction & Remodeling Businesses</span>
              </motion.div>
              ...
              <p className="text-lg sm:text-xl text-foreground-secondary mb-8 leading-relaxed">
                Complete construction business growth system: capture remodeling leads, automate project follow-ups, collect 5-star reviews, and manage all your builds — so you can focus on framing, foundations, and finishing projects, not chasing estimates.
              </p>
              
              <div className="flex flex-col sm:flex-row gap-3 mb-8 justify-center lg:justify-start">
                <Link
                  href="#pricing"
                  className="inline-flex items-center justify-center gap-2 h-12 px-7 bg-gradient-to-r from-orange-600 to-amber-600 text-white font-semibold rounded-xl transition-all duration-200 hover:brightness-110 shadow-[0_1px_2px_rgba(0,0,0,0.3),inset_0_1px_0_rgba(255,255,255,0.1)] hover:shadow-[0_4px_12px_rgba(249,115,22,0.4),inset_0_1px_0_rgba(255,255,255,0.1)] active:scale-[0.98]"
                >
                  View Construction Pricing
      ...
      <section className="py-20 relative">
        <Container>
          <SectionHeading
            ...
            title="Running a Construction Business Without vs. With Automation"
          ...
          <div className="grid md:grid-cols-2 gap-6 mt-12 max-w-4xl mx-auto">
            ...
            >
              ...
              <div className="relative rounded-2xl border border-orange-500/30 bg-gradient-to-br from-orange-500/5 to-amber-500/5 p-6">
                <div className="flex items-center gap-2 mb-4">
      ...
      <section className="py-20 relative">
        ...
        <Container>
          <SectionHeading
            overline="CONSTRUCTION FEATURES"
            title="Everything Your Construction Business Needs"
            highlightWord="Needs"
            subtitle="Stop juggling spreadsheets and missed calls. One system for remodeling quotes, new build estimates, renovation leads, and project management."
          />
      ...
      <section id="pricing" className="py-20 relative">
        <Container>
          <SectionHeading
            overline="CONSTRUCTION PRICING"
            title="Transparent Pricing for Contractors"
            highlightWord="Pricing"
            subtitle="No hidden fees. No surprises. Perfect for general contractors, remodeling firms, and construction companies."
          />
          ...
          <div className="mt-12">
            <PricingTiers tiers={getTiers()} accentColor="orange" />
              ...
              >
                ...
                <div className={`relative h-full rounded-2xl border ${tier.popular ? 'border-orange-500/50' : 'border-white/10'} bg-[linear-gradient(160deg,#181116_0%,#0f0b0e_100%)] overflow-hidden transition-all duration-300 hover:border-white/20`}>
                  {/* Popular badge */}
                  {tier.popular && (
                  ...
                  <div className="p-6 sm:p-8 flex flex-col h-full">
                    ...
                    <div className="mb-6">
                      {tier.popular && (
                        <span className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full text-xs font-semibold text-white bg-gradient-to-r from-orange-500 via-amber-500 to-orange-600 mb-3">
                    ...
                    <Link
                      ...
                      className={`w-full inline-flex items-center justify-center gap-2 h-11 px-5 font-semibold rounded-xl transition-all duration-200 mt-auto active:scale-[0.98] ${
                        tier.popular 
                          ? 'bg-gradient-to-r from-orange-600 to-amber-600 text-white hover:brightness-110 shadow-[0_1px_2px_rgba(0,0,0,0.3),inset_0_1px_0_rgba(255,255,255,0.1)] hover:shadow-[0_4px_12px_rgba(249,115,22,0.4),inset_0_1px_0_rgba(255,255,255,0.1)]'
      ...
      <section className="py-20 relative">
        ...
        <Container>
          <SectionHeading
            ...
            title="Launch Your Construction System in Days"
            highlightWord="Days"
          />
            ...
            {[
              {
                ...
                text: "15-minute consultation to discuss your construction services, project types, service areas, and branding.",
                icon: Calendar,
              },
              {
                num: "02",
                title: "We Build Your System",
                text: "Custom website, CRM, and automation workflows built specifically for your construction business. Ready in 3-7 days.",
                icon: Zap,
              },
              {
                num: "03",
                title: "Start Capturing Project Leads",
                text: "Go live and start converting remodeling quotes into contracts. We monitor performance and provide ongoing support.",
                icon: BarChart3,
              },
            ].map((step, index) => (
              <motion.div
              ...
              >
                ...
                <div className="relative rounded-2xl border border-white/10 bg-[radial-gradient(circle_at_20%_20%,rgba(249,115,22,0.08),transparent_38%),radial-gradient(circle_at_80%_0%,rgba(234,88,12,0.08),transparent_40%),linear-gradient(160deg,#181116_0%,#0f0b0e_100%)] p-6 h-full transition-all duration-300 hover:border-white/20 text-center">
                  {/* Step number badge */}
                  <span className="inline-flex items-center justify-center text-3xl font-bold bg-gradient-to-br from-orange-500/40 to-amber-500/40 bg-clip-text text-transparent mb-4 group-hover:from-orange-500 group-hover:to-amber-500 transition-all duration-300">
                    {step.num}
                  </span>
                  
                  <div className="w-14 h-14 rounded-xl bg-gradient-to-br from-orange-500/20 to-amber-500/20 flex items-center justify-center mx-auto mb-4 group-hover:scale-110 transition-transform duration-300 border border-orange-500/20">
      ...
      <section className="py-20 relative">
        ...
        <Container>
          ...
          >
            ...
            <div className="relative rounded-3xl border border-white/10 bg-[radial-gradient(circle_at_20%_20%,rgba(249,115,22,0.12),transparent_38%),radial-gradient(circle_at_80%_80%,rgba(234,88,12,0.12),transparent_40%),linear-gradient(160deg,#181116_0%,#0f0b0e_100%)] p-8 sm:p-12 text-center">
              ...
              <p className="text-foreground-secondary max-w-2xl mx-auto mb-8 leading-relaxed">
                Book a free 15-minute consultation. We&apos;ll discuss your construction services, project types, and show you how to automate your business growth.
              </p>
              <Link
                href="/schedule-a-call"
                className="inline-flex items-center justify-center gap-2 h-12 px-7 bg-gradient-to-r from-orange-600 to-amber-600 text-white font-semibold rounded-xl transition-all duration-200 hover:brightness-110 shadow-[0_1px_2px_rgba(0,0,0,0.3),inset_0_1px_0_rgba(255,255,255,0.1)] hover:shadow-[0_4px_12px_rgba(249,115,22,0.4),inset_0_1px_0_rgba(255,255,255,0.1)] active:scale-[0.98]"
              >
                <span className="hidden sm:inline">Schedule Your Free Construction Consultation</span>
                <span className="inline sm:hidden">Schedule Call</span>
                <ArrowRight className="w-5 h-5" />
              </Link>
              <p className="text-xs text-foreground-secondary mt-4">
                No commitment required • Perfect for contractors, remodelers, and builders
              </p>
            </div>
          </motion.div>
        </Container>
        ...
        <Container>
          <div className="text-center">
            <p className="text-sm text-foreground-secondary">
              Need a custom solution for your construction business?{" "}
              <Link href="/contact-us" className="text-orange-500 hover:text-orange-400 transition-colors underline">
                Contact us
              </Link>{" "}
