...
const tiers = [
  {
    name: "Launch",
    tagline: "Professional online presence for your HVAC business.",
    setupPrice: "$249",
    monthlyPrice: "$99",
    popular: false,
    included: [
  ...
  {
    name: "Growth",
    tagline: "Convert more HVAC leads into service contracts automatically.",
    setupPrice: "$549",
    monthlyPrice: "$149",
    popular: true,
    included: [
  ...
  {
    name: "Accelerator",
    tagline: "Scale your HVAC business with advanced automation.",
    setupPrice: "$999",
    monthlyPrice: "$299",
    popular: false,
    included: [
              ...
              >
                ...
                <div className={`relative h-full rounded-2xl border ${tier.popular ? 'border-cyan-500/50' : 'border-white/10'} bg-[linear-gradient(160deg,#181116_0%,#0f0b0e_100%)] overflow-hidden transition-all duration-300 hover:border-white/20`}>
                  ...
                  <div className="p-6 sm:p-8 flex flex-col h-full">
                    ...
                    <div className="mb-6">
                      {tier.popular && (
                        <span className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full text-xs font-semibold text-white bg-gradient-to-r from-cyan-500 via-sky-500 to-blue-500 mb-3">
                    ...
                    <Link
                      ...
                      className={`w-full inline-flex items-center justify-center gap-2 h-11 px-5 font-semibold rounded-xl transition-all duration-200 mt-auto active:scale-[0.98] ${
                        tier.popular 
                          ? 'bg-gradient-to-r from-cyan-600 to-sky-600 text-white hover:brightness-110 shadow-[0_1px_2px_rgba(0,0,0,0.3),inset_0_1px_0_rgba(255,255,255,0.1)] hover:shadow-[0_4px_12px_rgba(6,182,212,0.4),inset_0_1px_0_rgba(255,255,255,0.1)]'
