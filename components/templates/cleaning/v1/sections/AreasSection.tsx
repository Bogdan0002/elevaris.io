            ...
            <div className="bg-white rounded-3xl p-6 sm:p-8 shadow-xl shadow-slate-200/50 border border-slate-100">
              ...
              <div className="grid grid-cols-2 gap-4 mb-6">
                ...
                >
                  ...
                  >
                    {config.areasServed.length}
                  </div>
                  <div className="text-sm text-slate-600">Service Areas</div>
                </div>
                <div 
                  className="text-center p-4 rounded-2xl"
              ...
              <div className="pt-4 border-t border-slate-100">
                ...
                <div className="flex flex-col sm:flex-row gap-3">
                  <motion.a
                    ...
                    className="flex-1 flex items-center justify-center gap-2 px-5 py-3 rounded-xl font-semibold text-white text-sm"
                    style={{
                      background: `linear-gradient(135deg, ${primaryColor}, ${accentColor})`,
                    }}
                  ...
                  <motion.a
                    href="#contact"
                    className="flex-1 flex items-center justify-center gap-2 px-5 py-3 rounded-xl font-semibold text-sm border-2"
                    style={{
